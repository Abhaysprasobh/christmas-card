...
const Hero = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center h-screen bg-red-100 bg-cover bg-center text-red-800 text-center font-serif">
      {/* Snowfall Effect */}
      {showSnow && <Snowfall />}
      ...
      {showPopup && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="bg-red-50 rounded-lg shadow-lg p-6 relative max-w-md w-[90vw]">
            <button
              onClick={closePopup}
